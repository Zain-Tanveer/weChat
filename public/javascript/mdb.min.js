    ...
    (n = [
      ...
      function (M, t, e) {
        ...
        function Ii(t) {
          return 'html' === C(t)
            ? t
            : t.assignedSlot || t.parentNode || (bi(t) ? t.host : null) || Li(t)
        }
        function ki(t) {
          ...
          _bindActivateEvent() {
            s.on(this._element, ur, (t) => {
              this._showSubsection(),
                ...
                s.trigger(this._element, hr, { relatedTarget: t.relatedTarget })
            })
          }
        }
        s.on(window, w, () => {
        ...
        class Sr extends m {
          ...
          _keydown(t) {
            ...
            ;['ArrowLeft', Er, 'ArrowUp', xr].includes(t.key) &&
              ...
              (t.focus({ preventScroll: !0 }), Sr.getOrCreateInstance(t).show())
          }
          _getChildren() {
